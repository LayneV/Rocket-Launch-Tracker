...
function LaunchList({ listType }) {
  ...
  return (
    <div className="container mx-auto p-4">
      <h2 className="text-3xl font-bold dark:text-white mb-6 capitalize text-center [text-shadow:_0_1px_2px_rgba(0,0,0,0.05)] dark:[text-shadow:_0_0_8px_rgb(59_130_246)]">
        {listType} Launches
      </h2>
